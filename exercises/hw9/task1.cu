...
__global__ void my_reduce_kernel(int *data) {
  ...
  // task 1b: uncomment and create a proper 32-thread tile below, using group g1
  // created above auto g2 = FIXME task 1c: uncomment and create a proper
  // 16-thread tile below, using group g2 created above auto g3 = FIXME for each
  // task, adjust the group to point to the last group created above
  auto g = FIXME
